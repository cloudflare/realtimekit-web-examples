...
const sampleFiles: FileNode[] = [
  {
    ...
    type: "folder",
    url: "https://angular-examples-a7h.pages.dev/create-your-own-ui",
    usecase: "video",
    preset: "",
  ...
  },
  {
    ...
    type: "folder",
    url: "https:/angular-examples-a7h.pages.dev/default-meeting-ui",
    usecase: "all",
    preset: "",
  ...
  },
  {
    ...
    type: "folder",
    url: "https://angular-examples-a7h.pages.dev/with-video-transformer",
    usecase: "all",
    preset: "",
